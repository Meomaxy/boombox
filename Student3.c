...
void loop()
{
const int PROGMEM HTHNotes[] = {A2, A2, A2,
...
const int PROGMEM HTHLength = sizeof(HTHNotes) / sizeof(HTHNotes[0]);
//Finds the sizes of the two arrays
int counter2 = 0;
...
//Edge conditions to make sure the user doesn't immediatly pause and then unpause the
song
{
counter2++;
lcdDo(4);
